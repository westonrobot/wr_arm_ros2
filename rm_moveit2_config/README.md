...
# RealMan Robotic Arm rm_moveit2_config User Manual V1.2
...
|V1.2	  | 9/10 /2024 | Amend(Add GEN72 adapter files) |
...
```
Note that the above commands need to replace <arm_type> with the corresponding robotic arm model, which can be selected as 65, 63, eco65、eco63, gen72, and 75.  
