...
def generate_launch_description():
    ...
    # planning_context
    xacro_args = {"link6_type": "Link6_6fb"}
    ...
    robot_description_semantic_config = load_file(
        "rm_eco63_config", "config/rm_eco63_description.srdf"
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "rm_eco63_config", "config/moveit_controllers.yaml"
    )
    ...
    rviz_base = os.path.join(get_package_share_directory("rm_eco63_config"), "rviz")
